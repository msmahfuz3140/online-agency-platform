...
const variantMap: Record<StatusVariant, { dot: string; text: string; bg: string; border: string }> = {
  ...
  developer:    { dot: "bg-cyan-400",    text: "text-cyan-300",    bg: "bg-cyan-500/10",    border: "border-cyan-500/25" },
  support:      { dot: "bg-teal-400",    text: "text-teal-300",    bg: "bg-teal-500/10",    border: "border-teal-500/25" },
  editor:       { dot: "bg-emerald-400", text: "text-emerald-300", bg: "bg-emerald-500/10", border: "border-emerald-500/25" },
